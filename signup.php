...
<body>
  ...
  <form  action="checksign.php" method="post">
	...
	<div class="inputGroup inputGroup1">
		...
		<input type="text" id="email" class="email" name="email" placeholder="email@domain.com"/>
	...
	<div class="inputGroup inputGroup2">
		...
		<input type="password" id="password" class="password" name="confirm_password" />
	</div>
	<div class="inputGroup inputGroup3">
		<button type="submit" id="login">Đăng ký</button>
        <p style="margin-left: 50px;">Bạn đã có tài khoản <a href="./login.php">đăng nhập</a></p>
	</div>	
